...
Если не установлены, необходимо установить пакеты **Git** (для работы с Git Hub) и **curl** (инструмент командной строки для работы с HTTP-запросами).  
```console
...
JDK (Java Development Kit) — это комплект инструментов, для создания и запуска приложений на Java.  
