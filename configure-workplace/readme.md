...
JDK (Java Development Kit) — это комплект инструментов, для создания и запуска приложений на Java (Scala, Spark используют для исполнения JVM (Java Virtual Machine)). Рекомендуется версия 17.  
