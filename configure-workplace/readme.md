...
Рабочая среда на ОС Ubuntu **Linux 25.10 (Questing Quokka)** для изучения технологий, "домашней" разработки небольших систем и проведения различных экспериментов. Инструкция создана для  интересующихся, на примере существующей домашней среды и сведена в единый перечень шагов по установке.  
